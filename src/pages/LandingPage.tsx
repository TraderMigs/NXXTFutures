  ...
  const features = [
    {
      ...
      desc: 'Institutional-grade signals generated by Claude AI scanning 50 futures markets every hour. Order blocks, liquidity sweeps, FVGs — automatically identified and ranked.',
      accent: '#F59E0B',
    ...
    },
    {
      ...
      desc: 'Select any futures symbol, hit analyze — the Moon Lander fetches live OHLCV data, Claude AI dissects it across 3 timeframes, and returns a full SMC trade setup in under 60 seconds.',
      accent: '#00D4FF',
      ...
      <nav className="fixed top-0 left-0 right-0 z-50 px-6 py-4">
        <div className="max-w-7xl mx-auto flex items-center justify-between">
          ...
          <div className="flex md:hidden items-center gap-2">
            <button onClick={() => navigate('/login')}
              className="btn-glass px-4 py-2 rounded-xl text-sm text-gray-300" style={{ fontFamily: 'DM Sans' }}>
              Log In
            </button>
            <button onClick={() => navigate('/login')}
              className="btn-primary px-4 py-2 rounded-xl text-sm font-bold text-black relative"
              style={{ fontFamily: 'Syne' }}>
